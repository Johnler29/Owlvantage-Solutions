      ...
      <section className="flex-1 py-20 md:py-32 bg-gradient-to-br from-[#25badf]/5 to-[#1b2e45]/5">
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto text-center">
            <ScrollReveal as="div" variant="pop" className="mb-8">
            ...
            {/* Quick Links */}
            <ScrollReveal as="div" variant="fade-up" delay={100} className="space-y-4 mb-12">
              <Link href="/">
            ...
            {/* Helpful Links */}
            <ScrollReveal as="div" variant="pop" delay={160} className="bg-gray-50 p-8 rounded-lg border border-gray-200">
